...
function ForthFloor({ toggleRoomInfo, reserveInfo, triggerBindingOnMessageReceive }) {
    ...
    return (
        <>
            ...
            <div className={style.container}>
                ...
                <div className={`${style.item} ${style.small}`}>  <ConferenceRoom data={rooms[7]} toggleRoomInfo={toggleRoomInfo} setRooms={onMessageReceived} /> </div>
                ...
                <div className={`${style.item} ${style.large}`}> <ConferenceRoom data={rooms[8]} toggleRoomInfo={toggleRoomInfo} setRooms={onMessageReceived} /></div>
